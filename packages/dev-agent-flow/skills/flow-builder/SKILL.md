...
| **无流式 / 整段一次性输出 / 用户可见 LLM 文本** | **[part2-orchestration.md](references/part2-orchestration.md) § 流式输出** + **R-G009**；system-prompt `<STREAMING_OUTPUT>` |
| **联网 / 网页搜索 / 实时资讯 / 多源调研** | **[part3-tools-config.md](references/part3-tools-config.md) § 联网搜索** + `dev-engineer-toolkit`；system-prompt `<WEB_SEARCH>` |
